  ...
  return (
    <div className={cn("relative", className)} role="none">
      <div
        ...
        className={cn(
          "cursor-pointer hover:bg-primary-50 p-4 flex text-sm border-y-[0.5px] justify-between items-center gap-1 w-full text-left focus:outline-none focus:ring-2 focus:ring-primary-600 focus-visible:ring-2 rounded",
          sectionClassName
        )}
        role="menuitem"
