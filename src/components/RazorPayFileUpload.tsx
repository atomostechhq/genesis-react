...
const FileSvg = () => {
  return (
    ...
    >
      <path
        d="M21.498 0L33.9677 12.9678V38C33.9677 41.3136 31.2838 43.9998 27.9735 44H5.99412C2.68365 43.9999 0 41.3137 0 38V6C0 2.68633 2.68365 5.98625e-05 5.99412 0H21.498Z"
